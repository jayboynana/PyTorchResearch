...
def get_args_parser(add_help=True):
    ...
    parser.add_argument("--data-path", default="E:/jupyterlab/PyTorch Tutorial/dataset/mscoco2017", type=str, help="dataset path")
    parser.add_argument(
        "--dataset",
        default="coco",
        type=str,
